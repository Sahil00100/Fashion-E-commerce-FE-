...
const SingleProduct = (props) => {
  ...
  return(
    ...
    <ProductView 
      colors={state.products[1].colors} 
      images={state.products[1].images}
      title={state.products[1].title}
      full_description={state.products[1].full_description}
      price={state.products[1].price}
      rating={state.products[1].rating}
      reviews={state.products[1].reviews}
      data={state.products[1].data}
    />
  </div>
  );
};
